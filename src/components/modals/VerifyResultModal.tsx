...
const VerifyResultModal: React.FC<VerifyResultModalProps> = ({
  ...
  const hasDiscrepancies = () => {
    ...
    return (
      candidateVotesSum !== validVotes ||
      (validVotes + invalidVotes) !== totalVotes
    );
  };
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between py-2 font-semibold">
                ...
                <span className={calculateTotalVotes() === result.voteData.validVotes ? 'text-green-600' : 'text-red-600'}>
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <ul className="list-disc list-inside space-y-1">
                    {calculateTotalVotes() !== result.voteData.validVotes && (
                      <li>Sum of candidate votes ({calculateTotalVotes()}) does not match valid votes ({result.voteData.validVotes})</li>
                    )}
                    {(result.voteData.validVotes + result.voteData.invalidVotes) !== result.voteData.totalVotes && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={verificationAction === 'reject' ? 'Please provide a reason for rejection...' : 'Add any additional notes...'}
            />
            {errors.notes && (
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  {verificationAction === 'approve' ? 'Approve Result' : verificationAction === 'reject' ? 'Reject Result' : 'Submit'}
                </>
              )}
            </button>
          </div>
