...
const TrackAgentModal: React.FC<TrackAgentModalProps> = ({
  isOpen,
  onClose,
  agent,
}) => {
          ...
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-blue-900">
                Current Status: {getStatusText(locationUpdates[locationUpdates.length - 1]?.status || 'unknown')}
              </p>
              <p className="text-sm text-blue-700">
                Last updated: {locationUpdates[locationUpdates.length - 1] ? 
                  formatTime(locationUpdates[locationUpdates.length - 1].timestamp) : 'Never'}
              </p>
            </div>
          </div>
        </div>
