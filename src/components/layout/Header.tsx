...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <div className='relative z-10 flex-shrink-0 flex h-16 bg-white shadow'>
      ...
      <button
        type='button'
        className='flex items-center px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500 md:hidden'
        onClick={onMenuClick}
      >
      ...
      <button
        type='button'
        className='hidden md:flex md:items-center px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500'
